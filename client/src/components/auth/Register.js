          ...
          <div className="row">
            <div className="col-md-8 m-auto">
              ...
              <form noValidate onSubmit={this.onSubmit}>
                ...
                <TextFieldGroup   placeholder="Email Address" name="email" type="email" value={this.state.email} onChange={this.onChange} error={errors.email} info="This site uses Gravatar Profile Image" />
